...
app.get('/health', (req, res) => {
  res.json({ 
    status: 'OK', 
    tenant: 'newteststore123',
    database: 'tenant_newteststore123',
...
async function startServer() {
  try {
    ...
    app.listen(PORT, () => {
      console.log(`🚀 Tenant "newteststore123" backend running on http://localhost:${PORT}`);
      console.log(`📊 Database: tenant_newteststore123`);
