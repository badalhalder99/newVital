          ...
          <div>
            ...
            <div style={{ color: 'var(--mysass-text-secondary)', fontSize: '1.1rem', lineHeight: '1.7' }}>
              ...
              <p style={{ marginBottom: '1.5rem' }}>
                ...
                something different. A sourcing company that provides 
              ...
              <p style={{ marginBottom: '1.5rem' }}>
                ...
                partners beyond the confines limit.
              </p>
              <p>
                Today, as a true company with seasoned professionals at the 
                helm, we're combining because of international sourcing 
      ...
      <section className="mysass-section">
        <div className="mysass-card" style={{ 
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/contact" className="mysass-btn mysass-btn-primary">
              Become a Partner ➜
            </Link>
            <Link to="/services" className="mysass-btn mysass-btn-secondary">
              See Our Work
            </Link>
          </div>
        </div>
